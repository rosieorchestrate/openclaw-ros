...
setup(
    ...
    entry_points={
        'console_scripts': [
            'mock_notifier = surveillance_system.mock_notifier:main',
            'camera_node = surveillance_system.camera_node:main',
            'detector_node = surveillance_system.detector_node:main',
        ],
    },
)
